...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "hero-grid":
          "radial-gradient(circle at top, rgba(109, 209, 196, 0.12), transparent 35%), radial-gradient(circle at 85% 15%, rgba(247, 182, 109, 0.15), transparent 24%), linear-gradient(180deg, rgba(255,255,255,0.02), transparent)"
      }
    }
  },
  plugins: []
